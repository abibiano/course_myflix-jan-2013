...
describe Video do
	...
	it "returns multiple reviews for a video in reverse chronically order" do
			...
			review1 = video.reviews.create(content: "Review 1", rating: 1, user: user1, created_at: 1.day.ago)
			review2 = video.reviews.create(content: "Review 2", rating: 4, user: user2)

			video.reviews.should == [review2, review1]
	end
