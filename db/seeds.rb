...
category_commedies.videos.create(title: 'Family Guy', \
...
category_dramas.videos.create(title: 'Futurama', \
...
category_commedies.videos.create(title: 'Monk', \
...
category_commedies.videos.create(title: 'South Park', \
